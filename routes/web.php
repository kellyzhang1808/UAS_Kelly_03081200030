...
Route::resource('admin/formpegawai', 'App\Http\Controllers\Admin\formpegawaiController');
Route::resource('admin/tentangpegawai', 'App\Http\Controllers\Admin\tentangpegawaiController');
